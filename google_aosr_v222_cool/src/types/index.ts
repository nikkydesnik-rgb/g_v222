...
export interface AppState {
  ...
  // Actions
  addSavedOrganization: (org: SavedOrganization) => void;
  removeSavedOrganization: (id: string) => void;
  updateSavedOrganization: (id: string, org: Partial<SavedOrganization>) => void;
